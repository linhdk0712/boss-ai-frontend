...
// Use conditional navigation based on current route
const { conditionalNavItems } = useConditionalNavigation(navItems)
</script>

<template>
  <VerticalNavLayout :nav-items="conditionalNavItems">
    <!-- 👉 navbar -->
