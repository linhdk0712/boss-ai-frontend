  ...
  <VCard>
    <VRow no-gutters>
      <VCol cols="12" md="3" :class="$vuetify.display.smAndDown ? 'border-b' : 'border-e'">
        <VCardText>
          <AppStepper v-model:current-step="currentStep" :items="propertyListingSteps" direction="vertical"
      ...
      <VCol cols="12" md="9">
        <VCardText>
          ...
          <div class="d-flex flex-wrap gap-4 justify-space-between mt-6">
            ...
            <VBtn v-if="propertyListingSteps.length - 1 === currentStep" color="success" @click="onSubmit">
              submit
            </VBtn>
